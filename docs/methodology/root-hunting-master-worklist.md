...
- [~] network namespace merge series, veth merge provenance, and `ip netns` first-release archaeology.
  - **Completed — veth:** exact initial mainline commit `e314dbdc1c0dc6a548ecf0afce28ecfd538ff568`, initial pair/namespace intent, and first stable mainline presence in Linux 2.6.24; the bounded [public proposal/revision/acceptance slice](../routing/linux-veth-upstream-provenance.md) distinguishes June 6 proposal/review, July v2.1 patch and v3/v4 cover reports, August 8 local / August 9 UTC subsystem statement, and the preserved commit's separate author/committer dates (`SRC-0280..0285`, `SRC-0269`).
  - **Completed — kernel core:** the [September 2007 00/16 series plus 17/16 safety follow-up](../routing/linux-network-namespace-core-merge-series.md), contemporary partial/core-merge status, exact mainline anchors `5f256becd868bf63b70da8f2769033d6734670e9` (basic infrastructure), `ce286d327341295f58d89864d746a524287cfdf9` (device movement), and separate `9dd776b6d7b0b85966b6ddd03e2b2aae59012ab1` (CLONE_NEWNET clone/unshare).
  - **Completed — userspace:** the earlier 2008 PID-selected `ip link ... netns PID` interface; exact named/processless `ip netns` introduction commit `0dc34c7713bb7055378fe5cbc720d63d0db572a1` (2011-07-13); and the [first tagged release/source snapshot boundary](../routing/iproute2-ip-netns-first-tagged-release.md) at iproute2 v3.0.0, with v2.6.39 as the immediately preceding tag lacking `ip/ipnetns.c`.
  - **Still missing:** complete intermediate veth subpatches and earliest-prototype/first-deployment evidence; specific OpenVZ descent and Linus first-parent integration are not established. The kernel study still lacks a full numbered-patch Torvalds-tree SHA concordance; trace later protocol-family completion only where needed for operational claims. The stronger iproute2 first-public-distribution claim still needs a contemporary v3.0.0 announcement or original distribution artifact. These completed slices do not establish full-stack maturity or first deployment.
- [~] VRF device initial merge, netdev discussion, l3mdev abstraction/rule chronology and deployment evidence. **Completed:** [exact chronology](../routing/linux-vrf-l3mdev-mainline-chronology.md) now pins the 2015-02-04 public RFC, July device-model patch, initial mainline VRF commit `193125dbd8eb292d88feb201f030889b488b0a02` with v4.2→v4.3 tag boundary, explicit l3mdev generalization commit `1b69c6d0ae90b7f1a4f61d5c8209d5cb7a55f849` with v4.3→v4.4 boundary, and `FRA_L3MDEV`/automatic-rule commits `96c63fa7393d0a346acfe5a91e0c7d4c7782641b` + `1aa6c4f6b8cd84b8b36ebf43c6861ca87eab4da0` with v4.7→v4.8 boundary. Cumulus Linux 3.0 provides a June 2016 vendor-shipping lower bound. **Still missing:** the older out-of-tree VRF patch's exact identity/ancestry and the first named customer/site production deployment; vendor availability must not be rewritten as first real deployment.
