...
- [~] network namespace merge series, veth merge provenance, and `ip netns` first-release archaeology. **Completed:** exact initial veth mainline commit `e314dbdc1c0dc6a548ecf0afce28ecfd538ff568`, initial pair/namespace intent, and first stable mainline presence in Linux 2.6.24; the September 2007 00/16 core network-namespace series plus 17/16 safety follow-up; contemporary partial/core-merge status; exact mainline anchors `5f256becd868bf63b70da8f2769033d6734670e9` (basic infrastructure), `ce286d327341295f58d89864d746a524287cfdf9` (device movement), and separate `9dd776b6d7b0b85966b6ddd03e2b2aae59012ab1` (CLONE_NEWNET clone/unshare); the earlier 2008 PID-selected `ip link ... netns PID` interface; exact named/processless `ip netns` introduction commit `0dc34c7713bb7055378fe5cbc720d63d0db572a1` (2011-07-13); and the first tagged release/source snapshot boundary at iproute2 v3.0.0 with v2.6.39 as the immediately preceding tag lacking `ip/ipnetns.c`. **Still missing:** optional pre-mainline veth patch-series provenance; a full numbered-patch Torvalds-tree SHA concordance and later protocol-family completion only where needed for operational claims; and, for the stronger first-public-distribution claim, a contemporary v3.0.0 announcement or original distribution artifact. These completed slices do not establish full-stack maturity or first deployment.
